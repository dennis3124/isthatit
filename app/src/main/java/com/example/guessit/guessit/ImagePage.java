...
public class ImagePage extends AppCompatActivity {
    ...
    public int count=0;
    private Integer[] Imgid = {R.id.imageButton17,R.id.imageButton18,R.id.imageButton19,R.id.imageButton24,R.id.imageButton25,R.id.imageButton26,R.id.imageButton27,R.id.imageButton28 };
